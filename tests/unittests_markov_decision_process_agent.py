...
class TestMarkovDecisionProcessAgent(TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual({(1, 1, 1): 0, (1, 1, 2): 0, (1, 1, 3): 0, (1, 1, 4): 0, (1, 1, 5): 0, (1, 1, 6): 0, (1, 2, 2): 0, (1, 2, 3): 0, (1, 2, 4): 0, (1, 2, 5): 0, (1, 2, 6): 0, (1, 3, 3): 0, (1, 3, 4): 0, (1, 3, 5): 0, (1, 3, 6): 0, (1, 4, 4): 0, (1, 4, 5): 0, (1, 4, 6): 0, (1, 5, 5): 0, (1, 5, 6): 0, (1, 6, 6): 0, (2, 2, 2): 0, (2, 2, 3): 0, (2, 2, 4): 0, (2, 2, 5): 0, (2, 2, 6): 0, (2, 3, 3): 0, (2, 3, 4): 0, (2, 3, 5): 0, (2, 3, 6): 0, (2, 4, 4): 0, (2, 4, 5): 0, (2, 4, 6): 0, (2, 5, 5): 0, (2, 5, 6): 0, (2, 6, 6): 0, (3, 3, 3): 0, (3, 3, 4): 0, (3, 3, 5): 0, (3, 3, 6): 0, (3, 4, 4): 0, (3, 4, 5): 0, (3, 4, 6): 0, (3, 5, 5): 0, (3, 5, 6): 0, (3, 6, 6): 0, (4, 4, 4): 0, (4, 4, 5): 0, (4, 4, 6): 0, (4, 5, 5): 0, (4, 5, 6): 0, (4, 6, 6): 0, (5, 5, 5): 0, (5, 5, 6): 0, (5, 6, 6): 0, (6, 6, 6): 0},
                         self.agent._state_scores)
        self.assertEqual([], self.agent._changes)
        self.assertEqual(100000.0, self.agent._largest_change)
        ...
        self.assertEqual(0, self.agent._iterations)
    ...
    def test_update_state_best_action(self):
        ...
        self.assertEqual(14, self.agent._state_scores[(1, 1, 2)])

    def test_iterate_all_states_once(self):
        self.agent._iterate_all_states()
        self.assertEqual(324, self.agent._largest_change)

    def test_iterate_all_states_5_times(self):
        for _ in range(5):
            self.agent._iterate_all_states()
        self.assertEqual(0.013878447483153854, self.agent._largest_change)

    def test_update_largest_change(self):
        self.agent._changes = [1, 4, 2]
        self.agent._update_largest_change()
        self.assertEqual(4, self.agent._largest_change)
        self.assertEqual([], self.agent._changes)

    def test_iterate_until_minimal_change_01(self):
        self.agent._theta = 0.1
        self.agent._iterate_until_minimal_change()
        self.assertEqual(0.013878447483153854, self.agent._largest_change)
        self.assertEqual(5, self.agent._iterations)

    def test_iterate_until_minimal_change_0001(self):
        self.agent._theta = 0.001
        self.agent._iterate_until_minimal_change()
        self.assertEqual(0.00030390005456108526, self.agent._largest_change)
        self.assertEqual(7, self.agent._iterations)

    def test_init_with_iterations(self):
        agent = MarkovDecisionProcessAgent(self.game)
        self.assertEqual(0.00030390005456108526, agent._largest_change)
        self.assertEqual(7, agent._iterations)
